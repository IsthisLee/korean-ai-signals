...
>
> **지금 계획:** [분석 계획](plan.md)입니다. 배경과 용어 풀이부터 적혀 있습니다. 이 안내 문서는 계획을 고치기 전에 쓴 것이라 일부 내용이 계획과 다릅니다.
>
> **이 저장소:** 분석 장비와 계획, 결과를 담습니다. 결과는 Claude Code 플러그인 [korean-writing](https://github.com/IsthisLee/korean-writing) 의 검사 규칙과 윤문 도구를 고르는 데 씁니다.
>
> **지금 상태 (2026-09-17):** 1차·2차 파일럿을 마쳤고 본 측정 표본을 모으는 중입니다. 위키백과 300편, 기술 블로그 129편, 개인 블로그 58편을 모았습니다. 도구 비교 결과는 아직 없습니다.
>
...
| 질문          | 답                                                                             |
| ----------- | ----------------------------------------------------------------------------- |
| 무엇을 정하려고 하나 | ① 믿을 만한 AI 티 목록과 그 심각도 ② 함께 켜 둘 한국어 output style ③ 플러그인에 넣을 윤문 도구 ④ 플러그인 검사 훅에 남길 규칙           |
...
이 분석이 돕는 플러그인 [korean-writing](https://github.com/IsthisLee/korean-writing) 가 하려는 일은 Claude 가 쓰는 한국어를 **뜻은 그대로 두면서 AI 티가 덜 나게** 만드는 것입니다. 그러려면 두 가지 답이 먼저 있어야 합니다. 무엇이 AI 티인지, 그리고 어떤 도구가 뜻을 지키면서 그것을 줄이는지입니다. 지금은 둘 다 믿을 만한 답이 없습니다. 이유는 네 가지입니다.
...
그 플러그인의 예전 검사 훅은 「이 표현을 고쳐라」라고 알렸고, 그 안내대로 고친 글에서 원래 있던 내용이 빠졌습니다.

- 옛 안내대로 고친 대조 글 6편에서 정보 9건이 사라졌습니다([EVALUATION.md](https://github.com/IsthisLee/korean-writing/blob/main/EVALUATION.md) I절).
...
| 단계        | 하는 일                                                                       | 왜 이렇게 하나                                                           | 상태     |
| --------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------ | ------ |
| 0. 기준 공개  | 표본, 판정 기준, 비교 순서를 [분석 계획 문서](plan.md)에 먼저 적습니다        | 결과를 보고 기준을 고르면 원하는 결론에 맞춘 숫자가 나오기 때문입니다                            | 끝남     |
...
| 위키백과, 기업 기술 블로그, 개인 블로그          | 플러그인이 다루는 설명문·기술 문서에 가까운 글과, 편집을 거치지 않은 평범한 개인 글을 함께 보려는 것입니다                              |
| AI 글은 사람 글과 같은 주제로               | 주제가 다르면 흔적의 차이가 사실은 주제의 차이일 수 있습니다. 윤문 도구 im-not-ai 의 대조 측정도 이 한계를 스스로 적었습니다                 |
| AI 글은 Claude(Opus 5, Sonnet 5)로만 | 플러그인이 다루는 것이 Claude Code 가 쓰는 글이기 때문입니다                                                    |
...
- **검사 훅 규칙:** 지금 K 규칙과 표본에서 뽑은 표현마다, 흔적을 고르는 쪽 사람 글에서 가장 많이 나온 횟수보다 1 많은 횟수를 문턱으로 삼습니다. 사람 글 600편이 한 편도 문턱을 넘지 않고 확인용 Claude 글이 한 편 이상 넘은 규칙만 남깁니다. 지금 규칙도 사람 글을 잡으면 뺍니다([분석 계획 5.7절](plan.md#9-검사-훅-규칙을-정하는-법)).
...
아래는 **다른 연구자들이 발표한 결과**입니다. 이 분석에서 직접 잰 결과가 아닙니다.
...
43가지 후보는 여섯 묶음으로 나뉩니다. 전체 목록과 출처 원문은 [분석 계획 문서의 표](plan.md#6-재는-것)에 있습니다.
...
**후보에서 뺀 것.** 널리 알려졌거나 플러그인의 검사 훅이 쓰는 표현이지만, 위 기준에 맞는 연구를 찾지 못했습니다. 뺐다고 해서 AI 티가 아니라는 뜻은 아니고, 연구 근거가 아직 없다는 뜻입니다. 검사 훅 규칙은 이 목록과 따로, 본 측정 표본에서 사람 글을 잡는지 직접 재서 남길지 정합니다(2절).
...
사람 글 30편과 Claude 글 30편으로 수집부터 비교까지 한 번 돌렸습니다. 수치와 계산 방법은 [분석 계획 문서의 11절](../results/pilot)에 있습니다.
...
새 사람 글 30편과 Claude 글 30편으로 한 번 더 돌렸습니다. 이번에는 분석할 때 두 글의 길이를 맞췄고, 번역 글이 많은 블로그를 표본에서 뺐습니다. 수치는 [분석 계획 문서의 12절](../results/pilot2)에 있습니다.
...
본 측정이 끝나면 어느 흔적이 믿을 만했는지, 어느 도구가 어떤 점에서 나았는지, 플러그인이 무엇을 채택했고 왜 그렇게 정했는지를 이 문서에 적습니다.

자세한 기준, 계산 방법, 출처 원문은 [분석 계획 문서](plan.md)에 있습니다.
